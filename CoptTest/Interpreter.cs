...
namespace CoptTest
{
    public class Interpreter
    {
        ...
        {
            new object[] { "ⲛ̀Ⲇⲁⲩⲓⲇ", "enDăvid" },
            new object[] { "ⲁⲣⲭⲱⲛ", "ărkʰon" },
            new object[] { "ⲡ̀ⲁⲣⲭⲱⲛ", "epărkʰon" },
            new object[] { "ⲙ̀ⲡ̀ⲣⲉⲥⲃⲩⲧⲉⲣⲟⲥ", "em.epresviteros" },
            new object[] { "ⲛ̀ⲁ̀ⲣⲭⲏⲁⲅⲅⲉⲗⲟⲥ", "en.ărsʰiăngelos"},
            new object[] { "ⲛ̀ⲁ̀ⲣⲭⲏⲉ̀ⲣⲉⲩⲥ", "en.ărsʰi.erevs"},
            new object[] { "ⲛⲓⲉⲩⲭⲏ", "nievsʰi"},
            new object[] { "ⲉⲩⲭⲏ", "evsʰi"},
            new object[] { "ⲡ̀ⲯⲩⲭⲏ", "eppsisʰi"},
            new object[] { "ⲯⲩⲭⲏ", "psisʰi"},
            new object[] { "ⲭⲱ", "ko"},
            new object[] { "ⲙ̀ⲡⲓⲭⲱ", "empĭko"},
            new object[] { "ⲭⲱⲣⲓⲥ", "kʰorĭs"},
            new object[] { "Ⲭⲉⲣⲉ ⲛⲉ Ⲙⲁⲣⲓⲁ", "Sʰere ne Mărĭă" },
            new object[] { "Ⲱⲥⲁⲛⲛⲁ", "Osănnă" },
            new object[] { "Ⲡⲓⲭ̀ⲣⲓⲥⲧⲟⲥ", "Pi.ekʰrĭstos" },
            new object[] { "Ⲭⲣⲓⲥⲧⲟⲥ", "Kʰrĭstos" },
            new object[] { "ⲛⲓⲁ̀ⲅⲅⲉⲗⲟⲥ", "ni.ăngelos" },
            new object[] { "ⲛⲓⲁⲅⲅⲉⲗⲟⲥ", "niăngelos" },
            new object[] { "ⲓⲣⲏⲛⲏ", "ĭrini" },
            new object[] { "Ⲓⲥⲭⲩⲣⲟⲛ", "Ĭskĭron" },
            new object[] { "Ⲟⲩⲟϩ", "Owoh" },
            new object[] { "ⲁϥϭⲓⲥⲁⲣⲝ", "ăfcʰĭsărx" },
            new object[] { "ⲛ̀ⲛⲓⲡⲁⲭⲛⲏ", "ennipăkʰni" },
            new object[] { "Ⲧⲉⲛⲟⲩⲱϣⲧ ⲙ̀ⲙⲟⲕ ⲱ̀ Ⲡⲓⲭ̀ⲣⲓⲥⲧⲟⲥ: ⲛⲉⲙ Ⲡⲉⲕⲓⲱⲧ ⲛ̀ⲁ̀ⲅⲁⲑⲟⲥ: ⲛⲉⲙ Ⲡⲓⲡ̀ⲛⲉⲩⲙⲁ ⲉⲑⲟⲩⲁⲃ: ϫⲉ ⲁⲕⲓ̀ ⲁⲕⲥⲱϯ ⲙ̀ⲙⲟⲛ.",
                           "Tenuosʰt emmok o Pi.ekʰrĭstos: nem Pekyot en.ăgʰătʰos: nem Pi.epnevmă etʰowab: je ăk.ĭ aksotĭ emmon." },
        };
