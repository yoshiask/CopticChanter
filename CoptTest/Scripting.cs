...
namespace CoptTest
{
    public class Scripting
    {
        ...
        {
            var cmds = CoptLib.Scripting.Scripting.ParseTextCommands(@"This is some English, \ms{0:5:0}with a millisecond offset.", out var result);
        ...
        public void ParseTextCommands_LanguageCommand()
        {
            ...
            var cmds = CoptLib.Scripting.Scripting.ParseTextCommands($"This is some English, \\language{{{lang}}}{{{subtext}}}.", out var result);
