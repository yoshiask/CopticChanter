...
// https://github.com/dotnet/runtime/blob/955604c6620d0eaf9a10b4591449e377a6faa7d3/src/libraries/Common/src/System/Buffers/ArrayBufferWriter.cs
...
namespace CoptLib.Hyperspeed.Memory
{
    ...
    sealed class ArrayBufferWriter<T> : IBufferWriter<T>
    {
        ...
        {
            throw new InvalidOperationException($"Buffer advanced too far, capacity {capacity}");
        }
