    ...
    public sealed partial class StanzaEditorView : Page
    {
        ...
        private void LanguageOption_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                if (LanguageOption.SelectedIndex > -1)
                {
                    var language = (CoptLib.CopticInterpreter.Language)LanguageOption.SelectedIndex;
                    switch (language)
                    {
                        #region English
                        case CoptLib.CopticInterpreter.Language.English:
                            InitEnglish();
                            break;
                        #endregion

                        #region Coptic
                        case CoptLib.CopticInterpreter.Language.Coptic:
                            InitCoptic();
                            break;
                        #endregion

                        #region Arabic
                        case CoptLib.CopticInterpreter.Language.Arabic:
                            InitArabic();
                            break;
                            #endregion
                    }
